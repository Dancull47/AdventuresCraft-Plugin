            ...
            for (MercenaryItemList mercenary : MercenaryItemList.values()) {
                ...
                if (mercenaryItem != null) {
                    ...
                    if (economy.getBalance(player) >= mercenary.getPrice() * 16)
                        lore.add(Component.text(Prefix.PREFIX.getPrefix() + ChatColor.YELLOW + "Right-Click to Purchase " + ChatColor.GOLD + "16x " + ChatColor.YELLOW + "(⛂ " + numberFormat.numberFormat(mercenary.getPrice() * 16) + ")"));
                    if (economy.getBalance(player) >= mercenary.getPrice() * 32)
                        lore.add(Component.text(Prefix.PREFIX.getPrefix() + ChatColor.YELLOW + "Shift-Left-Click to Purchase " + ChatColor.GOLD + "32x " + ChatColor.YELLOW + "(⛂ " + numberFormat.numberFormat(mercenary.getPrice() * 32) + ")"));
                    if (economy.getBalance(player) >= mercenary.getPrice() * 64)
                        lore.add(Component.text(Prefix.PREFIX.getPrefix() + ChatColor.YELLOW + "Shift-Right-Click to Purchase " + ChatColor.GOLD + "64x " + ChatColor.YELLOW + "(⛂ " + numberFormat.numberFormat(mercenary.getPrice() * 64) + ")"));

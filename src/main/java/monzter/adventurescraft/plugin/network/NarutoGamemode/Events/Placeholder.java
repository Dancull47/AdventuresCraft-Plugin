package monzter.adventurescraft.plugin.network.NarutoGamemode.Events;
...
public class Placeholder extends PlaceholderExpansion {
    ...
    public String onRequest(OfflinePlayer player, String identifier) {
        ...
        switch (identifier) {
            ...
            case "SKILL_TREE_NARUTO_SHADOW_CLONE":
                return String.valueOf(getPoints("SKILL_TREE.NARUTO_SHADOW_CLONE", points));
            case "ATTRIBUTE_NARUTO":
                return String.valueOf(getPoints("ATTRIBUTE.NARUTO", points));

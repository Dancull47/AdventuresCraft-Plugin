...
public enum QuestList {
    ...
    RING_AROUND_THE_WITHER_ROSES(QuestGiver.KASSADIN,
            new String[]{"&aPick &f%betonquest_default-Void-Kassadin:point.RING_AROUND_THE_WITHER_ROSES.amount%/320 &aWither Roses", "&fatop the spirals within the &5Void"},
            null, null, 500, new String[]{AdventureStatsDisplay.MINING.getName() + ",500"}, 250),
    ...
    POP_A_VEIN(QuestGiver.KASSADIN,
            new String[]{"&aPop &f%betonquest_default-Void-Kassadin:point.POP_A_VEIN.amount%/10 &aVoid Veins &faround", "the spirals within the &5Void"},
            null, null, 500, new String[]{AdventureStatsDisplay.MINING.getName() + ",500"}, 250),

...
public class CooldownCondition extends SkillCondition implements IEntityCondition {

    final double cooldownSeconds;
    final String skillName;

    public CooldownCondition(MythicLineConfig config) {
    ...
    public boolean check(AbstractEntity target) {
        ...
        if (!Cooldown.isInCooldown(bukkitTarget.getUniqueId(), "cast")) {
            ...
            if (!cooldownCheck((Player) bukkitTarget, skillName))
                return false;

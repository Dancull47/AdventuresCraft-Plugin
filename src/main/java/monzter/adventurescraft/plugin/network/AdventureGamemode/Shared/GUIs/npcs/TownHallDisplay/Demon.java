...
public class Demon extends BaseCommand {
    ...
    public Demon(AdventuresCraft plugin, SoundManager soundManager, GUIHelper guiHelper, ConsoleCommand consoleCommand, MMOItems mmoItems) {
        this.plugin = plugin;
    ...
    @CommandAlias("DemonDisplay")
    @CommandPermission("*")
    public void mainMenu(Player player) {

        ChestGui gui = new ChestGui(6, guiHelper.guiName("Demon"));

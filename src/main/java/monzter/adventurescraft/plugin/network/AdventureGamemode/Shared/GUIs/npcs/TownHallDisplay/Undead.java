...
public class Undead extends BaseCommand {
    ...
    public Undead(AdventuresCraft plugin, SoundManager soundManager, GUIHelper guiHelper, ConsoleCommand consoleCommand, MMOItems mmoItems) {
        this.plugin = plugin;
    ...
    @CommandAlias("UndeadDisplay")
    @CommandPermission("*")
    public void mainMenu(Player player) {

        ChestGui gui = new ChestGui(6, guiHelper.guiName("Undead"));
        ...
        display.addItem(new GuiItem(mmoItems.getItem("SWORD", "BONE_SWORD4")), 5, 2);

...
public class Bullbo extends BaseCommand {
    ...
    public Bullbo(AdventuresCraft plugin, SoundManager soundManager, GUIHelper guiHelper, ConsoleCommand consoleCommand, MMOItems mmoItems) {
        this.plugin = plugin;
    ...
    @CommandAlias("BullboDisplay")
    @CommandPermission("*")
    public void mainMenu(Player player) {

        ChestGui gui = new ChestGui(6, guiHelper.guiName("Bullbo"));
        ...
        display.addItem(new GuiItem(mmoItems.getItem("ARMOR", "BULLBO_HEAD")), 4, 1);
        display.addItem(new GuiItem(mmoItems.getItem("ARMOR", "BULBLIN_CHEST")), 4, 2);

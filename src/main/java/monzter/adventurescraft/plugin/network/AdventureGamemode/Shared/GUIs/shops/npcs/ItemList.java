...
public enum ItemList {
    ...
    FARMING_ACCESSORIES1(Shops.FARMING_ACCESSORIES, 1, MMOItems.plugin.getItem("ACCESSORY", "POWERFUL_NECKLACE3"), 0, new ItemStack[]{MMOItems.plugin.getItem("MATERIAL", "ENCHANTED_CARROT").asQuantity(9)}, new String[]{"MINING,5", "SLAYER,5"}),
    FARMING_ACCESSORIES2(Shops.FARMING_ACCESSORIES, 1, MMOItems.plugin.getItem("ACCESSORY", "POWERFUL_NECKLACE4"), 0, new ItemStack[]{MMOItems.plugin.getItem("ACCESSORY", "POWERFUL_NECKLACE3").asQuantity(1), MMOItems.plugin.getItem("MATERIAL", "ENCHANTED_CARROT").asQuantity(32)}, null),
    FARMING_ACCESSORIES3(Shops.FARMING_ACCESSORIES, 1, MMOItems.plugin.getItem("ACCESSORY", "POWERFUL_NECKLACE5"), 0, new ItemStack[]{MMOItems.plugin.getItem("MATERIAL", "ENCHANTED_CARROT").asQuantity(64)}, null),

    BLAST_FURNACE1(Shops.BLAST_FURNACE, 64, new ItemStack(Material.COAL), 0, new ItemStack[]{MMOItems.plugin.getItem("MATERIAL", "COAL_SHARD").asQuantity(9)}, null),
    BLAST_FURNACE2(Shops.BLAST_FURNACE, 64, new ItemStack(Material.IRON_INGOT), 0, new ItemStack[]{MMOItems.plugin.getItem("MATERIAL", "IRON_SHARD").asQuantity(9)}, null),
    BLAST_FURNACE3(Shops.BLAST_FURNACE, 64, new ItemStack(Material.GOLD_INGOT), 0, new ItemStack[]{MMOItems.plugin.getItem("MATERIAL", "GOLD_SHARD").asQuantity(9)}, null),
    BLAST_FURNACE4(Shops.BLAST_FURNACE, 64, new ItemStack(Material.DIAMOND), 0, new ItemStack[]{MMOItems.plugin.getItem("MATERIAL", "DIAMOND_SHARD").asQuantity(9)}, null),
    BLAST_FURNACE5(Shops.BLAST_FURNACE, 64, new ItemStack(Material.EMERALD), 0, new ItemStack[]{MMOItems.plugin.getItem("MATERIAL", "EMERALD_SHARD").asQuantity(9)}, null),

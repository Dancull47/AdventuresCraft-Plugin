...
public enum DonationItemList {
    ...
    CratesITEM1(DonationShops.CRATES, 100, 8, "CONSUMABLE", "HELL_BOX5"),
    CratesITEM2(DonationShops.CRATES, 100, 8, "CONSUMABLE", "UNDEAD_BOX5"),
    CratesITEM3(DonationShops.CRATES, 100, 8, "CONSUMABLE", "PROFESSION_BOOSTER_BOX5"),
    ;

...
public enum EnchantedMaterialList {
    ...
    COAL("ENCHANTED_COAL"),
    IRON("ENCHANTED_IRON_INGOT"),
    GOLD("ENCHANTED_GOLD_INGOT"),
    REDSTONE("ENCHANTED_REDSTONE"),
    LAPIS("ENCHANTED_LAPIS_LAZULI"),
    ...
    ENDERPEARL("ENCHANTED_ENDER_PEARL"),

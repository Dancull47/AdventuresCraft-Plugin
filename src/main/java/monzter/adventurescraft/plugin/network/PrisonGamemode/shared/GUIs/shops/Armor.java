...
enum ArmorList {
    ...
    HELMET4("PRISONER_HAT4", 1_000),
    HELMET5("PRISONER_HAT5", 5_000),
    HELMET6("PRISONER_HAT6", 10_000),
    HELMET7("PRISONER_HAT7", 20_000),

    CHESTPLATE1("PRISONER_CHESTPLATE", 250),
    CHESTPLATE2("PRISONER_CHESTPLATE2", 500),
    CHESTPLATE3("PRISONER_CHESTPLATE3", 1_000),
    CHESTPLATE4("PRISONER_CHESTPLATE4", 2_000),
    CHESTPLATE5("PRISONER_CHESTPLATE5", 10_000),
    CHESTPLATE6("PRISONER_CHESTPLATE6", 20_000),
    CHESTPLATE7("PRISONER_CHESTPLATE7", 100_000),

    LEGGINGS1("PRISONER_LEGGINGS", 200),
    LEGGINGS2("PRISONER_LEGGINGS2", 400),
    LEGGINGS3("PRISONER_LEGGINGS3", 800),
    LEGGINGS4("PRISONER_LEGGINGS4", 1_600),
    LEGGINGS5("PRISONER_LEGGINGS5", 8_000),
    LEGGINGS6("PRISONER_LEGGINGS6", 16_000),
    LEGGINGS7("PRISONER_LEGGINGS7", 50_000),

    SHOES1("PRISONER_SHOES", 100),
    SHOES2("PRISONER_SHOES2", 200),
    SHOES3("PRISONER_SHOES3", 400),
    SHOES4("PRISONER_SHOES4", 800),
    SHOES5("PRISONER_SHOES5", 4_000),
    SHOES6("PRISONER_SHOES6", 8_000),
    SHOES7("PRISONER_SHOES7", 25_000),

    HELMET8("PRISONER_HAT8", 175_000),
    CHESTPLATE8("PRISONER_CHESTPLATE8", 300_000),
    LEGGINGS8("PRISONER_LEGGINGS8", 250_000),
    SHOES8("PRISONER_SHOES8", 150_000),

    HELMET9("PRISONER_HAT9", 250_000),
    CHESTPLATE9("PRISONER_CHESTPLATE9", 500_000),
    LEGGINGS9("PRISONER_LEGGINGS9", 400_000),
    SHOES9("PRISONER_SHOES9", 200_000),
